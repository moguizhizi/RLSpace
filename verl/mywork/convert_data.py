...
if __name__ == "__main__":
    d1 = make_dataset("MR/data_think/output/TFG1/test_sft.json", "verl/mywork/data/test.parquet")
    d2 = make_dataset("MR/data_think/output/TFG1/train_sft.json", "verl/mywork/data/train.parquet")
    d3 = make_dataset("MR/data_think/output/TFG1/val_sft.json", "verl/mywork/data/val.parquet")
